...
import { TableColumns } from '@/components/master-price/TableColumns';
import { MasterPriceTableProps } from '@/types/master-price';

export const TableMasterPrice = ({
  data,
  isLoading,
  onEdit,
  onDelete,
      ...
      >
        <div className="w-full min-w-max bg-white text-left text-slate-700">
          ...
          {isLoading ? (
            ...
            <EmptyState
              title="No Master Price Found"
              description="Try adding a new master price or adjusting your search."
            />
          ) : (
            <div
              style={{
