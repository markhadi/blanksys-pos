...
import { BrandTableProps } from '@/types/brand';
import { useMemo, useRef } from 'react';
import { TableCard } from '@/components/ui/TableCard';
import { TableSkeleton } from '@/components/ui/TableSkeleton';
import { EmptyState } from '@/components/ui/TableEmptyState';
import { TableConfig } from '@/components/brand/TableConfig';
import { createColumns } from '@/components/brand/CreateColumns';
        ...
        <div className="w-full min-w-max bg-white text-left text-slate-700">
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Try adding a new brand or adjusting your search."
            />
          ) : (
            <div
              style={{
